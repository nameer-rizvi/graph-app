...
const defaultConfigs = [
  {
    ...
    seriesConfigs: [
      ...
      ["phaseAccumulationPriceLevel", "PL: Accumulation", "#50082e", ["$"]],
      ["phaseDistributionPriceLevel", "PL: Distribution", "#1f4113", ["$"]],
      ["pressureBuyingPriceLevel", "PL: Buying", "#101655", ["$"]],
      ["pressureSellingPriceLevel", "PL: Selling", "#141b1f", ["$"]],
      ["volumeValuePriceLevel", "PL: Value", "#50082e", ["$"]],
      ["priceRangeDiffPriceLevel", "PL: Volatility", "#1f4113", ["$"]],
    ],
  },
  {
    show: true,
